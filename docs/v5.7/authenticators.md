...
[HTTP 客户端](/v5.7/clients/http.html)需要[认证器](https://github.com/pac4j/pac4j/blob/master/pac4j-core/src/main/java/org/pac4j/core/credentials/authenticator/Authenticator.java)来验证凭据。
...
- [LDAP](/v5.7/authenticators/ldap.html)
- [SQL](/v5.7/authenticators/sql.html)
- [JWT](/v5.7/authenticators/jwt.html)
- [MongoDB](/v5.7/authenticators/mongodb.html)
- [CouchDB](/v5.7/authenticators/couchdb.html)
- [IP address](/v5.7/authenticators/ip.html)
- [REST API](/v5.7/authenticators/rest.html)
...
默认情况下，`LocalCachingAuthenticator` 使用 Guava 作为其内部[存储](/v5.7/store.html)，但你可以通过 `setStore` 方法提供自己的存储。
