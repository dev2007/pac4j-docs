...
**授权器（Authorizer）** 用于在访问 URL 时检查授权（在“[安全过滤器](/v5.7/security-filter.html)”中）：
...
通常，授权器是在应用程序的[安全配置](/v5.7/config.html)中定义的。

有如下可用的授权器：

- [角色/权限](/v5.7/authorizers/profile-authorizers.html#_1-角色-权限)——[匿名/记住我/（完全）授权](/v5.7/authorizers/profile-authorizers.html#_2-授权级别)——[Profile 类型、属性](/v5.7/authorizers/profile-authorizers.html#_3-其他)
