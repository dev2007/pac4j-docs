...
*pac4j* 附带了一组满足各种需求的庞大组件，因此在进行任何定制之前，你应该仔细阅读[客户端](/v4.0/clients.html)、[认证器](/v4.0/authenticators.html)和[授权者](/v4.0/authorizers.html)页面，以检查已经提供的内容。
...
> [原文链接](https://www.pac4j.org/4.0.x/docs/customizations.html)
