...
要检查用户配置文件上的角色和权限，首先需要使用 [AuthorizationGenerator](/v5.0/clients.html#_2-计算角色和权限) 计算它们。
...
> [原文链接](https://www.pac4j.org/5.0.x/docs/authorizers/profile-authorizers.html)
